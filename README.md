Tasks to solve:
    1. Timer appear in the heading
    2. Press Start to play the game 
    3. Local storage (WAtch video of Loi again)
    4. Monster move automatically by itself
    5. Start button keep flashing
